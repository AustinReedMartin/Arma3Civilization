...
_maxVeiwDist = 1500; //Maximum Veiw Distance

_minObjViewDist = 500; //Minimum Object Veiw Distance
_maxObjViewDist = 1200; //Maximum Object Veiw Distance
/////////////////
//CONFIG END
////////////////
...
// _GoBackBtn ctrlSetEventHandler ["ButtonClick","['apps', 1] call ExileClient_gui_xm8_slide"];
...
disableSerialization;
  ...
  ["apps", 0] call ExileClient_gui_xm8_slide;
  uiSleep 1;
  {
    ctrlDelete ((findDisplay 24015) displayCtrl _x);
  } forEach _vdCtrls;
