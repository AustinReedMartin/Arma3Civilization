...
try
{
	...
	format["wasteHistory:%1:%2:%3:%4:%5:%6:%7:%8:%9", _playerUID, _playerName, _revenue, _respectGain, _vehClass, _cargo, str(mapGridPosition getPos _playerObject), _playerMoney, _playerRespect] call ExileServer_system_database_query_fireAndForget;
