...
try 
{
	...
	format["insertSellHistory:%1:%2:%3:%4:%5:%6:%7:%8:%9", _playerUID, _playerName, _sellPrice, _respectGain, _itemClassName, str(mapGridPosition getPos _playerObject), _quantity, _playerMoney,_playerRespect] call ExileServer_system_database_query_fireAndForget;
