...
try 
{
	...
	format["itemBuyHistory:%1:%2:%3:%4:%5:%6:%7", _playerUID, _playerName, _salesPrice, _itemClassName, str(mapGridPosition getPos _playerObject), _quantity, _playerMoney] call ExileServer_system_database_query_fireAndForget;
