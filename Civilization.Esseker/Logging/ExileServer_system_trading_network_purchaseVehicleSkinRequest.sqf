...
try 
{
	...
	format["vehPaintHistory:%1:%2:%3:%4:%5:%6:%7", _playerUID, _playerName, _salesPrice, _vehClass, str(mapGridPosition getPos _playerObject), _playerMoney, _skinClassName] call ExileServer_system_database_query_fireAndForget;
