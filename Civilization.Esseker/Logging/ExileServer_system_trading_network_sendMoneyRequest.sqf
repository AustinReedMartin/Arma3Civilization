...
try 
{
	...
	_senderPlayerUID = getPlayerUID _senderPlayerObject;
	_senderPlayerName = name _senderPlayerObject;
	...
	_receiverPlayerUID = getPlayerUID _receiverPlayerObject;
	_receiverPlayerName = name _receiverPlayerObject;
	...
	format["poptabSendHistory:%1:%2:%3:%4:%5",_senderPlayerUID,_senderPlayerName,_amountToTransfer,_receiverPlayerUID,_receiverPlayerName] call ExileServer_system_database_query_fireAndForget;;
}
catch 
{
