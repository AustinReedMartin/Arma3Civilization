...
switch _className do {
    case "C_SUV_01_F": { _vehicleObject setObjectTextureglobal [0,"textures\sticker.jpg"] };
    case "B_MRAP_01_F": { _vehicleObject setObjectTextureglobal [0,"textures\swat_hunter.jpg"] };
    case "B_MRAP_01_gmg_F": { _vehicleObject setObjectTextureglobal [0,"textures\violence_hunter.jpg"] };
    case "B_Heli_Light_01_F": { _vehicleObject setObjectTextureglobal [0,"textures\little.jpg"] };
    case "C_Hatchback_01_F": { _vehicleObject setObjectTextureglobal [0,"textures\asiimov.jpg"] };
};
_vehicleObject